...
const UserProfile = () => {
  ...
  <div className='border border-purple-700 p-5 rounded-2xl shadow-md bg-white relative'>
    ...
    <div className="space-y-4">
      <div>
        <label className="text-base font-semibold text-gray-500 uppercase tracking-wide ">Full Name</label>
        <p className="text-3xl font-medium truncate">{user?.name}</p>
      </div>

      <div className="flex items-center gap-2">
        <FiMail className='text-lg' />
        <a href={`mailto:${user?.email}`} className="hover:underline  truncate text-xl">{user?.email}</a>
      </div>

      <div className="flex items-center gap-2">
        <FiPhone className='text-lg' />
        <a href={`tel:${user?.phone}`} className="hover:underline  truncate text-xl">{user?.phone}</a>
      </div>
    </div>
   ...
   <div className='border border-purple-700 p-5 rounded-2xl shadow-md bg-white'>
    ...
    <div className="relative">
      ...
      <button
        ...
        className="absolute right-3 top-[40%] transform -translate-y-1/2 text-purple-700"
