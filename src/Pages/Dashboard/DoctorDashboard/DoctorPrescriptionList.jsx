...
const DoctorPrescriptionList = () => {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gray-50 min-h-screen">
          ...
          return (
            ...
            >
              ...
              <div className="flex gap-3 mt-4">
                ...
                <button
                  onClick={() => {
                    // Pass the complete prescription object without normalizing IDs
                    setEditingPrescription(p);
                  }}
                  className="flex-1 flex items-center justify-center gap-2 bg-yellow-500 text-white py-2 px-4 rounded-lg hover:bg-yellow-600 text-sm font-medium transition-all"
                >
                  <FaEdit />
                  Edit
                </button>
      ...
      {/* Add the form for editing prescriptions */}
      {editingPrescription && (
        <PrescriptionForm
